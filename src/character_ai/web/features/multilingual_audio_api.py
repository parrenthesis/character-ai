...
from ...features.localization.multilingual_audio import (
...
# Global instances
_multilingual_audio_manager: Optional[MultiLanguageAudioService] = None


def get_multilingual_audio_manager_dependency() -> MultiLanguageAudioService:
    """Dependency to get multilingual audio manager instance."""
    return get_multilingual_audio_manager()
...
async def synthesize_speech(
    ...
    manager: MultiLanguageAudioService = Depends(
        get_multilingual_audio_manager_dependency
    ),
) -> TTSResponse:
