...
from ...web.streaming import StreamingConfig as LLMConfig
from ...web.streaming import (
    StreamingLLM,
    StreamingLLMWebSocketController,
    StreamingMode,
)
from ...web.streaming.audio import StreamingAudioProcessor
from ...web.streaming.audio import StreamingConfig as AudioConfig
from ...web.streaming.audio import StreamingWebSocketController
...
audio_handler: Optional[StreamingWebSocketController] = None
llm_handler: Optional[StreamingLLMWebSocketController] = None
...
async def audio_websocket(websocket: WebSocket) -> None:
    ...
    try:
        ...
        if audio_handler is None:
            audio_handler = StreamingWebSocketController(processor)
...
async def llm_websocket(websocket: WebSocket) -> None:
    ...
    try:
        ...
        if llm_handler is None:
            llm_handler = StreamingLLMWebSocketController(processor)
