...
class VoiceService(VoiceManagerProtocol):
    ...
    async def initialize(self) -> None:
        ...
        self.voice_storage_dir.mkdir(parents=True, exist_ok=True)
        logger.info(
            f"VoiceService initialized with storage dir: {self.voice_storage_dir}"
        )
