...
class CharacterBundler:
    ...
    def _create_runtime_config(
        ...
        profile_service = HardwareProfileManager()
        hardware_config = profile_service.load_profile(hardware_profile)

        # Merge configurations
        merged_config = profile_service.merge_with_config(hardware_config, base_config)
