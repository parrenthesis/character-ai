...
class TestLLMProvidersSimple:
    ...
    def test_local_llm_provider_import(self):
    ...
    def test_local_llm_provider_basic(self, mock_llama):
    ...
    def test_openai_provider_basic(self):
    ...
    def test_anthropic_provider_basic(self):
